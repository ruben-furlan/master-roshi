...
public class RestaurantController {
	...
	public BookingResponse<RestaurantRest> getRestaurantById(@PathVariable Long restaurantId) throws BookingException {
		return new BookingResponse<>("Succes", HttpStatus.OK.name(), "OK", this.restaurantService.getRestaurantById(restaurantId));
	}
	...
	public BookingResponse<List<RestaurantRest>> getRestaurants() throws BookingException {
		return new BookingResponse<>("Succes", HttpStatus.OK.name(), "OK", this.restaurantService.getRestaurants());
	}
